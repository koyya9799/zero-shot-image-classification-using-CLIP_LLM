...
LLM_PROVIDER=auto will try OpenAI first and fall back to Gemini. You can force a provider with LLM_PROVIDER=openai or LLM_PROVIDER=gemini.

If you see errors like model ... is not found for API version v1beta, set GEMINI_MODEL to a model available in your Google project.
